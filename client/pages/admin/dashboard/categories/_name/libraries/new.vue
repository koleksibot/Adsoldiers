	...
	<div class="row-2">
		...
		<div class="col-sm-12">
			<div class="form-group dash-group">
				...
				/>
				<p class="text-danger p-2" v-for="error in errors.description">
					{{ error }}
				</p>
			</div>
		</div>
		<div class="col-sm-12 col-md-6">
			<div class="form-group dash-group">
				...
				<p class="text-danger p-2" v-for="error in errors.category">
					{{ error }}
				</p>
			</div>
		</div>
		<div class="col-sm-12">
			<div class="form-group dash-group">
				...
				<input
					...
					multiple
				/>
				<p class="text-danger p-2 mt-10" v-for="error in errors.cover_img">
					{{ error }}
				</p>
			</div>
		</div>
	...
	export default {
		...
		methods: {
			handleSubmition() {
				...
				this.$axios
					.$post('libraries/create', formData, {
						header: {
